    ...
    try {
      ...
      try {
        ...
        if (userInfoStr) {
          ...
          if (userInfo?.token) {
            authHeader = { 'Authorization': `Bearer ${userInfo.token}` };
          }
        }
      } catch (e) {
      ...
      if (data.status === 'success' && data.response) {
        ...
        const errorMessage = data.message || "I'm sorry, I couldn't process your request at the moment. Please try again.";
